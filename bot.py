...
async def on_message(message):
   ...
   if "!hero" in message.content:
       await message.channel.send("`HERO BOT`")
   ...
   if "covid" in message.content or "Covid" in message.content or "COVID" in message.content or "hero" in message.content or "Hero" in message.content or "HERO" in message.content:
